...
PLAN = [("Trip Planner","planner/"),("Best Time to Visit","travel/best-time-to-visit-gb/"),
        ...
        ("Road & Pass Status","status/"),("Weather","weather/"),("Tours","tours/"),("What to Eat","food/"),
...
def build_footer(p):
    return (f'<footer>\n  <div class="footer-inner">\n    <div class="footer-top">\n'
        f'      <div><a href="/" class="footer-logo">{MARK_F}<span class="l1">GB</span><span class="l2">Guide</span></a>'
